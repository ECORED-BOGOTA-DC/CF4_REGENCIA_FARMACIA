...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #base.row.justify-content-around.align-items-center(data-aos="zoom-in-down")
      .row.col-11
        .row.mt-5
          .col-md-6.col-lg-4
            .anchorBtn
      ...
      .row
        ...
        .col-md-7.mb-4.mb-md-0
          ...
          ul.lista-ul--color.fa-ul2
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p.mb-0 Solicitar información, documentos o copias de documentos. 
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p.mb-0 Pedir que se preste un servicio. 
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
      ...
      .row
        ...
        .col-md-7.mb-4.mb-md-0
          ...
          ul.lista-ul--color.fa-ul2
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p.mb-0 Defensoría del Pueblo. 
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p.mb-0 Procuraduría General de la Nación. 
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p.mb-0 Personerías distritales y municipales. 
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
      ...
      .row
        ...
        .col-md-7.mb-4.mb-md-0
          ...
          ul.lista-ul--color.fa-ul2
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p El acto o la omisión que motivó la acción de tutela con la mayor claridad posible.
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p El derecho a ser infringido o amenazado.
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p El nombre de la autoridad pública o el nombre de la persona que infringió o amenazó el derecho subyacente, si corresponde; otras circunstancias relacionadas en la solicitud.
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p El nombre del solicitante, el lugar de residencia, la dirección, etc.
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
      ...
      .row
        ...
        .col-md-7.mb-4.mb-md-0
          ul.lista-ul--color.fa-ul2
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p Cualquier persona a nombre propio.
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p A través de representante legal, por ejemplo, el padre o la madre respecto a sus hijos.
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p Por medio de abogado, y se hace necesario anexar el documento mediante el cual se transfiere a este, la facultad de actuar en su nombre. 
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
              p A través de agente oficioso, o sea, una persona cercana a aquella que sufre la vulneración, cuando esta última no se encuentre en condiciones físicas, mentales o cualquier circunstancia que le impida promover su propia defensa.
            li(data-aos="fade-up") 
              i.ii.fas.fa-atom
